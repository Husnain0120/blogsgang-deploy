    ...
    return (
        <Fragment>
            ...
            <Dialog className=" relative  right-[1em] w-[25em]  md:right-0 md:w-0 lg:right-0 lg:w-0" open={open} handler={handleOpen} style={{ background: mode === 'light' ? '#2f3542' : '#2f3542', color: mode === 'dark' ? 'white' : 'black' }}>
                {/* DialogBody  */}
                <DialogBody >
                    <div className="flex justify-center flex-wrap  sm:mx-auto sm:mb-2 -mx-2 bg-lime-700 rounded-md py-2  mt-4 mb-2 ">
                        {/* main  */}
                        <div className="">
                    ...
                    <div className=" text-center">
                        <h1 className=" text-gray-600">Powered By BlogGang</h1>
                    </div>
                </DialogBody>
            </Dialog>
        </Fragment>
