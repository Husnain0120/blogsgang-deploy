    ...
    const navList = (
        <ul className="mb-4 mt-2 flex  flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            ...
            <Typography
                ...
                style={{ color: mode === 'dark' ? 'white' : 'white' }}
            >
                <Link to={'/allblogs'} className="flex items-center  hover:p-2 p-2 rounded-md hover:bg-blue-gray-300">
                    Blogs
                </Link>
            </Typography>
            <Typography
                ...
                style={{ color: mode === 'dark' ? 'white' : 'white' }}
            >
                <Link to={'/adminlogin'} className="flex items-center  hover:p-2 p-2 rounded-md hover:bg-blue-gray-300">
                    Admin Login
                </Link>
            </Typography>
            <Typography
                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/home'}>
                        ...
                        >
                            ...
                            <img
                                className=' w-10 h-10 '
                                src='https://cdn-icons-png.freepik.com/256/12104/12104790.png?uid=R98459826&ga=GA1.1.1114926933.1708955695&semt=ais_hybrid'
                            />
                            {/* Logo Text  */}
                            <span>
                                BlogGang
                        ...
                        <div>
                           {admin ?  <Link to={'/dashboard'}>
                                <div className="">
                                    <Avatar
                                        key={1}
                                        src={'https://cdn-icons-png.freepik.com/256/6024/6024190.png?uid=R98459826&ga=GA1.1.1114926933.1708955695&semt=ais_hybrid'}
                                        alt="avatar"
                                        withBorder={true}
