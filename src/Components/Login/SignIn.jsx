...
function SignIn() {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      setLoading(false);
      setShowLogoutDialog(false); // Hide the dialog after logout
    }
  };
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="text-sm text-center font-bold leading-9 tracking-tight text-gray-900">
            ...
            <span>
              <Link to="/" className="font-mono text-blue-700 hover:underline">
                Signup
              </Link>
            </span>
          </p>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div className="disclaimer text-center mt-4">
            <p className="text-sm text-gray-600">
              Disclaimer: By signing in, you agree to our terms and privacy policy.
            </p>
          </div>
        </div>
      </div>
